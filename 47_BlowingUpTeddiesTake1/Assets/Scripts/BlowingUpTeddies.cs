...
public class BlowingUpTeddies : MonoBehaviour
{
	...
	[SerializeField]
	Sprite greenTeddyBearSprite;
	[SerializeField]
	Sprite purpleTeddyBearSprite;
	[SerializeField]
	Sprite yellowTeddyBearSprite;
    ...
    void Update()
    {
        ...
        //{
		//	gameObjects.Clear();
		//	gameObjects.AddRange(FindObjectsByType<GameObject>(FindObjectsSortMode.None));
		//}
	...
	void BlowUpTeddies(TeddyColor color)
	{
		...
		//		if ((color == TeddyColor.Green && sprite == greenTeddyBearSprite) ||
		//			(color == TeddyColor.Purple && sprite == purpleTeddyBearSprite) ||
		//			(color == TeddyColor.Yellow && sprite == yellowTeddyBearSprite))
		//      {
